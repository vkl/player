...
enum CastMessageType sendMessage(struct MessageQueueItem **item,
...
enum CastMessageType processData(struct MessageQueueItem **msgQueueItem,
        struct MessageItem **item, struct CastState *cs, uint8_t *buf, uint16_t buflen);
